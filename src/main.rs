...
async fn main() {
    let mut swarm = Swarm::new(1_000, 5);
    ...
    loop {
        ...
        swarm.update_behaviors(
            (alignment_rows, alignment_cols, 0.02),
            (cohesion_rows, cohesion_cols, 0.01),
            (separation_rows, separation_cols, 0.06),
            (20.0, 0.1),
        );
